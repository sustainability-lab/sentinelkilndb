...
::: {.btn-group}
[Paper PDF](https://openreview.net/pdf?id=efGzsxVSEC){.btn}
[Download Dataset](https://www.kaggle.com/datasets/rishabhsnip/sentinelkiln-dataset){.btn}
[View Code](https://github.com/rishabh-mondal/NeurIPS_2025){.btn}
[Sustainability Lab](https://sustainability-lab.github.io/){.btn}
:::
:::
:::
...
:::
::: {.author-affiliation}
IIT Gandhinagar, [Sustainability Lab](https://sustainability-lab.github.io/)
:::
:::
:::
:::
...
```bibtex
@inproceedings{
mondal2025sentinelkilndb,
title={SentinelKiln{DB}: A Large-Scale Dataset and Benchmark for {OBB} Brick Kiln Detection in South Asia Using Satellite Imagery},
